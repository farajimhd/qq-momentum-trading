...
def _validate_strategy_lifecycle(
    ...
    if not routes and engine_parameters.get('structural_recovery_contract') != 'v6-structural-recovery-1' and engine_parameters.get('macd_hod_contract') != 'macd-hod-100ms-1':
