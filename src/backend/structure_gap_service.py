...
def calculate(request):
    ...
    if cursor.build['version'] not in ('causal-swing-closing-book-4','causal-swing-closing-book-5','causal-swing-closing-book-6'):raise ValueError('Select a v4, v5 or v6 swing book')
    ...
    for t,high,low,close in cursor.bars:
        ...
        levels=[l for l in snap['unified_levels'] if l.get('book_version') in ('causal-swing-closing-book-5','causal-swing-closing-book-6')
