...
def chart_rows(build_id, ticker, start, end, fingerprint=None, *, after=None, contract=CONTRACT):
    ...
    with _LOCK:
        ...
        if timeline is None:
            if build.get('version') in ('causal-swing-closing-book-1', 'causal-swing-closing-book-2', 'causal-swing-closing-book-3', 'causal-swing-closing-book-4', 'causal-swing-closing-book-5'):
