    ...
    controls: sessionDate ? <div className="hindsight-controls">
      ...
      {anchor ? <HindsightDetails anchor={anchor} onClose={close} title="Swing structure prototype">
        ...
        <form className="chart-settings-section" onSubmit={e => { e.preventDefault(); generate(); }}>
          ...
          <p className="chart-settings-help">Reversal distance freezes at each new extreme; prior volatility is capped relative to the bps/tick floor. Adjacent boundary touches count as one encounter. A major level needs meaningful rejection or a failed return after price moves away. Interior fluctuations inside an established trading range do not create extra major levels. Untested local levels expire after 30 minutes, major after 2 hours.</p>
